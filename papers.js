...
window.PAPERS = {
  journal: [
    { cite: 'W. Xing, M. Li, M. Li, M. Han. <a href="https://arxiv.org/abs/2502.13175" target="_blank" rel="noopener">Towards robust and secure embodied ai: A survey on vulnerabilities and attacks</a>. 2026. ACM Computing Surveys.' },
    { cite: 'Z. Xu, M. Han, X. Yue, W. Xing. <a href="https://www.sciengine.com/SSI/articleIndex?doi=10.1360/SSI-2025-0022&scroll=" target="_blank" rel="noopener">InSty: A Robust Multi-Level Cross-Granularity Fingerprint Embedding Algorithm for Multi-Turn Dialogue in Large Language Models</a>. SCIENTIA SINICA Informationis.' },
    { cite: 'Z. Wang, Y. Chen, Y. Yao, M. Han, W. Xing, M. Li. <a href="https://ieeexplore.ieee.org/abstract/document/11098842" target="_blank" rel="noopener">IDCNet: Image Decomposition and Cross-view Distillation for Generalizable Deepfake Detection</a>. IEEE TIFS.' },
    { cite: 'W. Xing, J. Chen, Y. Guo. <a href="https://link.springer.com/article/10.1007/s11633-022-1381-9" target="_blank" rel="noopener">Robust Local Light Field Synthesis via Occlusion-aware Sampling and Deep Visual Feature Fusion</a>. Machine Intelligence Research 20, 408–420 (2023).' },
    { cite: 'W. Xing, J. Chen, Z. Yang, Q. Wang, Y. Guo. <a href="https://ieeexplore.ieee.org/document/9894276" target="_blank" rel="noopener">Scale-Consistent Fusion: from Heterogeneous Local Sampling to Global Immersive Rendering</a>. IEEE TIP, 2022, 31: 6109–6123.' },
    { cite: 'W. Xu, F. Murphy, X. Xu, W. Xing. <a href="https://www.sciencedirect.com/science/article/abs/pii/S0747563221001746" target="_blank" rel="noopener">Dynamic communication and perception of cyber risk: Evidence from big data in media</a>. Computers in Human Behavior, 122, 106851, 2021.' }
  ],
  conference: [
    { cite: 'W. Xing, M. Fang, G. Wang, C. Lin, M. Han. Silencing the Guardrails: Inference-Time Jailbreaking via Dynamic Contextual Representation Ablation. Findings of ACL 2026.' },
    { cite: 'W. Xing, Z. Qi, Y. Qin, Y. Li, C. Chang, J. Yu, C. Lin, Z. Xie, M. Han. <a href="https://arxiv.org/abs/2508.10991" target="_blank" rel="noopener">MCP-Guard: A Defense Framework for Model Context Protocol Integrity in Large Language Model Applications</a>. Findings of ACL 2026.' },
    { cite: 'Z. Yu*, W. Xing*, W. Luo, W. Xu, L. Huang, Y. Chen, C. Lin, M. Han. DISF: Detecting Hallucinations in Retrieval-Augmented Generation via Dual-path Internal State Forcing Framework. Findings of ACL 2026.' },
    { cite: 'Y. Zhou*, W. Xing*, D. Kong, C. Lin, M. Han. Parameter Localization and Relearning for Safety Disalignment in Large Language Models. ICASSP 2026.' },
    { cite: 'Z. Xu, X. Tian, W. Zeng, W. Xing, T. Lu, G. Li, C. Chen, M. Han. KINGUARD: Hierarchical Kinship-Aware Fingerprinting to Defend Against Large Language Model Stealing. ICASSP 2026.' },
    { cite: 'Z. Xu, H. Zhang, Z. Wang, Q. Liu, H. Xu, W. Xing, M. Han. FORGETMARK: Stealthy Fingerprint Embedding via Targeted Unlearning in Language Models. ICASSP 2026.' },
    { cite: 'Z. Wang, X. Mu, Z. Zhou, M. Li, W. Xing, D. Kong, M. Han. ICPO: Illocution-Calibrated Policy Optimization for Multi-Turn Conversation. ICASSP 2026.' },
    { cite: 'J. Li, Z. Wang, T. Lu, M. Li, W. Xing, M. Han. Spectral Logit Sculpting: Adaptive Low-Rank Logit Transformation for Controlled Text Generation. ICASSP 2026.' },
    ...
    { cite: 'W. Xing, J. Chen, Z. Yang, X. Tong, C. Lin, M. Han. <a href="https://ieeexplore.ieee.org/abstract/document/10889871" target="_blank" rel="noopener">NCDI-Diffusion: Neural Contextual and Directional Inversion to Diffusion Models for Novel View Synthesis</a>. ICASSP, India, 2025.' },
    { cite: 'C. Hu, X. Teng, W. Xing, H. Chen, C. Ye, M. Han. <a href="https://ieeexplore.ieee.org/abstract/document/10888729" target="_blank" rel="noopener">Distill To Detect: Amplifying Anomalies in Backdoor Models through Knowledge Distillation</a>. ICASSP, 2025.' },
    { cite: 'X. Tong, B. Jin, J. Wang, W. Xing, T. Xia, M. Han. <a href="https://ieeexplore.ieee.org/abstract/document/10890123" target="_blank" rel="noopener">IDE: A Multi-Agent-Driven Iterative Framework for Dynamic Evaluation of LLMs</a>. ICASSP, 2025.' },
    { cite: 'J. Zhang, Z. Xu, R. Hu, W. Xing, X. Zhang, M. Han. <a href="https://arxiv.org/abs/2506.12551" target="_blank" rel="noopener">MEraser: An Effective Fingerprint Erasure Approach for Large Language Models</a>. ACL 2025.' },
    { cite: 'W. Xing, J. Chen. <a href="https://www.computer.org/csdl/proceedings-article/icme/2023/689100c183/1PTMC4TlFzq" target="_blank" rel="noopener">CasTensoRF: Cascaded Tensorial Radiance Fields for Novel View Synthesis</a>. ICME, Brisbane, Australia, 2023.' },
    { cite: 'W. Xing, J. Chen, S. See, C. Cheung. <a href="https://dl.acm.org/doi/abs/10.1145/3581783.3612010" target="_blank" rel="noopener">IRCasTRF: Inverse Rendering by Optimizing Cascaded Tensorial Radiance Fields, Lighting, and Materials from Multi-view Images</a>. ACM MM, Ottawa, Canada, 2023.' },
    { cite: 'W. Xing, J. Chen. <a href="https://dl.acm.org/doi/10.1145/3503161.3547795" target="_blank" rel="noopener">MVSPlenOctree: Fast and Generic Reconstruction of Radiance Fields in PlenOctree from Multi-view Stereo</a>. ACM MM, Lisbon, Portugal, 2022.' },
    { cite: 'W. Xing, J. Chen. <a href="https://www.ecva.net/papers/eccv_2022/papers_ECCV/papers/136750321.pdf" target="_blank" rel="noopener">Temporal-MPI: Enabling Multi-Plane Images for Dynamic Scene Modelling via Temporal Basis Learning</a>. ECCV, Tel Aviv, Israel, 2022.' },
    { cite: 'W. Xing, J. Chen. <a href="https://ieeexplore.ieee.org/document/9746938" target="_blank" rel="noopener">Nex+: Novel View Synthesis with Neural Regularisation over Multi-Plane Images</a>. ICASSP, Singapore, 2022.' }
  ],
  preprints: [
